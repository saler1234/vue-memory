<template>
  ...
  <button v-if="newPlayer" @click="startGame" class="button"><img src="../public/images/play.svg" alt="Restart Icon"> Start Game</button>
...
import { launchConfetti } from '@/composables/confetti'
    ...
    watch(userSelection, currentValue => {
      ...
      if (currentValue.length === 2) {
        ...
        if (cardOne.faceValue === cardTwo.faceValue) {
          // if matched, keep cards facing front
          cardList.value[cardOne.position].matched = true
          cardList.value[cardTwo.position].matched = true
        } else {
          setTimeout(() => {
            // if mismatched, flip cards back
